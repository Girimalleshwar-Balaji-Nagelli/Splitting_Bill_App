...
import com.example.splittingbillapp.Adapters.RecyclerViewAdapter_Item
...
class SplitByItemFragment : Fragment() {

    private lateinit var recyclerView : RecyclerView
    private lateinit var adapter: RecyclerViewAdapter_Item
    ...
    private lateinit var users: List<ExpandableMessage>
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_split_by_item, container, false)

        recyclerView = view.findViewById(R.id.recview_for_split_by_item)
        var totalAmount = 0.0
        ...
        adapter = RecyclerViewAdapter_Item(users)
